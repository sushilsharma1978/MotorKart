...
public class StoreDetailModel {
    String sid,cid,name,email,phone,store_num,instt_charge,discount,ratings,address,state_id,city_id,
            area_id,location, timings,isDeleted,status;

    public StoreDetailModel(String sid, String cid, String name, String email, String phone,
                            ...
                            String location, String timings, String isDeleted, String status) {
      this.setSid(sid);
      this.setCid(cid);
      this.setEmail(email);
      this.setPhone(phone);

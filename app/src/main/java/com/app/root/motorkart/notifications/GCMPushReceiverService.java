...
public class GCMPushReceiverService extends FirebaseMessagingService {
   ...
   /* @Override
    ...
    private void sendNotif2(){
        ...
        Intent ii = new Intent(getApplicationContext(), HomeScreeeen.class);
    ...
    private void sendNotification() {
      /*  Intent intent = new Intent(this, Login_activity.class);
       ...
       // PendingIntent pendingIntent = PendingIntent.getActivity(this, requestCode, intent, PendingIntent.FLAG_ONE_SHOT);
        ...
        noBuilder.setColor(getResources().getColor(R.color.darkorange));

        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            noBuilder.setSmallIcon(R.drawable.applogoo);
            noBuilder.setLargeIcon(BitmapFactory.decodeResource(getResources(), R.drawable.applogoo));
        } else {
            noBuilder.setSmallIcon(R.drawable.applogoo);
        }
